...
const WordsFilter: React.FC<WordsFilterProps> = ({ jwtToken, onApplyFilter }) => {
  ...
  const fetchTags = async () => {
    const response = await fetch('https://localhost:44376/api/Tag?tagType=0', {
      headers: {
        Authorization: `Bearer ${jwtToken}`,
        'Content-Type': 'application/json',
      },
